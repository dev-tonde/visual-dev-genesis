...
const Projects = () => {
  ...
  const verifiedRepoNames = useMemo(
    () =>
      status === 'ready'
        ? new Set(enrichedProjects.map((project) => project.name.toLowerCase()))
        : null,
        ...
        >
          <motion.div variants={itemVariants} className="mb-16">
            ...
            <div className="mt-4 flex flex-wrap items-center justify-center gap-2">
              ...
              {status === 'ready' && (
                <Badge variant="outline">Curated demo links when available</Badge>
              )}
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="mb-6 text-center">
            ...
            <p className="mt-3 text-muted-foreground max-w-2xl mx-auto">
              This list stays connected to GitHub. The case studies above are curated write-ups; the
              cards below remain live repo snapshots.
            </p>
          </motion.div>
          ...
          {loading ? (
            ...
            >
              ...
              <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
                This section only shows verified public repositories. When new projects are
                published on GitHub, they will appear here automatically.
              </p>
              <Button variant="outline" asChild>
                <a href={profileUrl} target="_blank" rel="noopener noreferrer">
                  <Github className="w-4 h-4 mr-2" />
            ...
            >
              ...
              <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
                Try a different search term or use the filters above to return to the live GitHub
                project list.
              </p>
            ...
            <div className="space-y-6">
              {hasPartialProjectData && (
                <div className="rounded-xl border border-border/60 bg-muted/30 px-4 py-3 text-sm text-muted-foreground">
                  Some repositories only include verified code links because no public demo URL or
                  repository description was provided.
                </div>
              )}
                      ...
                      <CardContent className="space-y-4">
                        <p className="text-muted-foreground text-sm leading-relaxed">
                          {project.description?.trim() ||
                            'No public description provided in the repository.'}
                        </p>
                        ...
                        <div className="space-y-3 pt-4">
                          <Button size="sm" variant="outline" className="w-full hover-lift" asChild>
                          ...
                          {project.demoLink ? (
                            ...
                            >
                              ...
                              >
                                ...
                                {project.demoLink.source === 'curated_demo'
                                  ? 'Live Demo'
                                  : 'Open Link'}
                              </a>
                            </Button>
                            ...
                            <p className="text-xs text-muted-foreground">
                              Code is available on GitHub. No verified public demo link is listed
                              for this project.
                            </p>
                          )}
                        </div>
