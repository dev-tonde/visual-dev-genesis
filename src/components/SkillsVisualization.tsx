...
const SkillsVisualization = () => {
  ...
  const skills: Skill[] = [
    ...
    { name: 'Framer Motion', level: 88, category: 'frontend', color: 'hsl(var(--secondary))' },
    { name: 'Node.js', level: 80, category: 'backend', color: 'hsl(var(--accent))' },
    { name: 'MongoDB', level: 75, category: 'backend', color: 'hsl(var(--primary))' },
    { name: 'PostgreSQL', level: 78, category: 'backend', color: 'hsl(var(--secondary))' },
